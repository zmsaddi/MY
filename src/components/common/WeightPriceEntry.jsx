...
export default function WeightPriceEntry({
  ...
  weightMode: initialWeightMode = 'per_sheet',
  pricingMode: initialPricingMode = 'per_kg',
  label = '',
  value = '',
  totalWeight = '',
  pricePerKg = '',
...
WeightPriceEntry.propTypes = {
  mode: PropTypes.oneOf(['weight', 'price', 'both']),
  weightMode: PropTypes.oneOf(['per_sheet', 'total_weight']),
  pricingMode: PropTypes.oneOf(['per_kg', 'per_piece', 'fixed_price']),
  label: PropTypes.string,
  value: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  totalWeight: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  pricePerKg: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  pricePerPiece: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  totalCost: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  quantity: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  weight: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  onChange: PropTypes.func,
  currencySymbol: PropTypes.string,
  showBatchPrice: PropTypes.bool,
