    ...
    try {
      ...
      for (const piece of validPieces) {
        ...
        const sheetData = {
          ...
          weight_per_cm2: currentSaleData.weight_per_cm2 || null, // Inherit from parent for weight calculation
          is_remnant: true,
          parent_sheet_id: currentSaleData.sheetId,
          created_from_sale_id: currentSaleData.saleId || null // Link to creating sale for deletion tracking
        };
